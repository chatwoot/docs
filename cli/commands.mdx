...
Full command reference. New here? Start with **[Getting started](index.md)**. For output formats and automation, see **[Scripting & output](scripting.md)**.
...
For pipelines and exports using these flags, see **[Scripting & output](scripting.md)**.
