...
<img src={require('./images/addinboxsettings1.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings2.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings2a.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings3.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings4.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings5.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings6.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings7.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings8a.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/addinboxsettings9.png').default} width="800" alt="Enable Developer Mode" />
...
Also, there is an option to Enable CSAT. Once you enable this Customer Satisfaction survey will be launched on Resolving each ticket. The CSAT results can be viewed later in Reports section.

Click on Campaigns on the Inbox Settings.

<div align="center">

<img src={require('./images/campaigns1.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/collaborators1.png').default} width="800" alt="Enable Developer Mode" />
...
Click on Create a Campaign on the right hand side. Below Window will pop open.

<div align="center">

<img src={require('./images/campaigns2.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/campaigns3.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/prechatform2.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/businesshour1.png').default} width="800" alt="Enable Developer Mode" />
...
<img src={require('./images/businesshour2.png').default} width="800" alt="Enable Developer Mode" />
