...
2. Follow the [Linux VM instructions](/self-hosted/deployment/linux-vm).
...
Refer to the [Linux VM environment configuration guide](/self-hosted/deployment/linux-vm#configure-the-required-environment-variables).
